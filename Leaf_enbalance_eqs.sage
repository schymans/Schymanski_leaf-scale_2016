...
# 
# Note: This worksheet is prepared for the open source software [sage](http://www.sagemath.org). It relies on definitions provided in Worksheet [Worksheet_setup](Worksheet_setup.ipynb), which has to be in the same directory.
...
var2('g_swmol', 'Stomatal conductance to water vapour',mole/meter^2/second,latexname='g_{w,mol}')
...
save_session('Leaf_enbalance_eqs')
